...
const Account = () => {
  const { user, loading, secureLogout } = useUser();
  ...
  const handleLogout = async () => {
    ...
    try {
      ...
      Toast.show({
        type: "error",
        text1: "Çıkış yapılırken hata oluştu",
        position: "top",
      });
    }
  };
  ...
  // Kullanıcı verisi yoksa fallback data kullan
  const userData = user || {
          ...
          <Card.Content style={styles.cardContent}>
            <View style={styles.infoItem}>
              ...
              <Text style={styles.infoText}>
                {userData.name_surname || "Ad Soyad Belirtilmemiş"}
              </Text>
            </View>
            ...
            <View style={styles.infoItem}>
              ...
              <Text style={styles.infoText}>
                {userData.phone_number || "Telefon Belirtilmemiş"}
              </Text>
            </View>
            <Divider style={styles.divider} />
            <View style={styles.infoItem}>
              ...
              <Text style={styles.infoText}>
                {userData.email || "E-posta Belirtilmemiş"}
              </Text>
            </View>
          </Card.Content>
        </Card>
      ...
      {!user && (
        <View style={styles.statusContainer}>
          <Text style={styles.statusText}>
            ⚠️ Demo modunda çalışıyor - Gerçek kullanıcı verileri yüklenemedi
          </Text>
        </View>
      )}
